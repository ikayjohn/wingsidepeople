...
-- CreateIndex
CREATE INDEX "Announcement_pinned_publishedAt_idx" ON "Announcement"("pinned" DESC, "publishedAt" DESC);
...
-- CreateIndex
CREATE INDEX "Policy_category_title_idx" ON "Policy"("category", "title");
